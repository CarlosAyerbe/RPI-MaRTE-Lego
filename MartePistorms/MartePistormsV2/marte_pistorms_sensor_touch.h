 ...
 * @return  -1 if there is an error, or 1 if the sensor is correct. See \ref PistormsCodes
 * 
 ...
 * count with \ref pistorms_reset_touches
 */
 ...
 * @param connector_id Bank and Port to plug the sensor
 * @return Pistorms codes, see \ref PistormsCodes
 * 
